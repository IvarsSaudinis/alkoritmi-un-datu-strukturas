 /*
  * 1.Uzrakstīt C++ programmu, kas, izmantojot steku, nosaka, vai 
  * simbolu virknē ir vienāds burtu A un B skaits.
  * 
  * Algoritms gadījumam,   * kad A skaits ir lielāks nekā B: ja 
  * nolasa A, stekā ieliek 1, ja * nolasa B, no steka 1 izņem; 
  * ja programmas beigās steks ir tukšs, * tātad = nolasīto A un B skaits ir vienāds.
  * -- 
